# individual-assignment-1-my-class-journal-branqwynn-1
individual-assignment-1-my-class-journal-branqwynn-1 created by GitHub Classroom
...
What, specifically, did you do extra?  This section must be completed to earn points for doing something extra. (added a FetchByDate class to IJournalServices and implemented it in journalServices. Additionally I created a JUnit test to make sure that the new function was performing properly.)
